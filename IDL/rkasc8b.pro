...
v_=[-sin(!PI/3),cos(!PI/3),0]*2*!PI*a/Torb
;L1
;x3_=[0d,0d,0d]
;L2
...
;while ((total(x1_) gt -3.7218d13) and (it lt Nt)) do begin
  ...
  calcf, x_ + b61*xk1_n + b62*xk2_n + b63*xk3_n + b64*xk4_n + b65*xk5_n, v_ + b61*vk1_n + b62*vk2_n + b63*vk3_n + b64*vk4_n + b65*vk5_n,P_,tt(it)+a6*dt,x3_p,v3_p
  xk6_n = dt*x_p
  vk6_n = dt*v_p
...
close,1
print,Cj(1),Cj(it)
print,Cj(it)-Cj(1),(Cj(it)-Cj(1))/Cj(1)
window,1
plot,deriv(Cj),xrange=[0,it]
window,2
